  ...
  return (
    ...
    Our Products
      ...
      <div className="flex flex-wrap gap-1 lg:gap-1 md:gap-1 xl:gap-12 2xl:gap-12 place-content-center px-2">
        <div class="flex justify-between w-[60vh] lg:mb-10 md:mb-10 mb-5 flex-col rounded-xl text-gray-700 bg-slate-300 bg-clip-border shadow-lg">
          <div class="p-6">
            <h5 class="mb-2 block font-sans text-xl text-gray-700 font-semibold">
              VAMBOX
            </h5>
        ...
        <div class="flex w-[60vh] lg:mb-10 md:mb-10 mb-8 flex-col justify-between rounded-xl text-gray-700 bg-slate-300 bg-clip-border shadow-lg">
          <div class="p-6">
            <h5 class="mb-2 block font-sans text-xl font-semibold text-gray-700 ">
              TryKaroo
            </h5>
            <p class=" block font-sans text-base font-light">
